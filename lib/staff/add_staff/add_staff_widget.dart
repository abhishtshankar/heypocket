...
class AddStaffWidget extends StatefulWidget {
  ...
  final List<StaffRecord>? staffList;
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowDropDown<String>(
                                            controller: _model
                                                    .paymentTypeDropDownValueController ??=
                                            ...
                                            onChanged: (val) => setState(() =>
                                                _model.paymentTypeDropDownValue =
                                                    val),
                                            width: double.infinity,
                                            height: 50.0,
                                            textStyle:
                        ...
                        onPressed: () async {
                          ...
                          await ChatsRecord.collection.doc().set({
                            ...createChatsRecordData(
                              lastMessage: 'you are admitted to this project',
                              lastMessagTime: getCurrentTimestamp,
                            ),
                            ...mapToFirestore(
                              {
                                'users': functions.getChatUserList(
                                    currentUserEmail,
                                    _model.textController4.text),
                                'userNames': functions.getChatUserList(
                                    currentUserEmail,
                                    _model.textController4.text),
                              },
                            ),
