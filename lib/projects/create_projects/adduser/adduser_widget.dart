                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            'Please Please add the following groups to the project: vendors, staff, and customers. the following users to the project',
                                        ...
                                        children: [
                                          StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<CustomersVendorsRecord>
                                                  dropDownCustomersVendorsRecordList =
                                                  snapshot.data!;
                              ...
                              if (_model.choiceChipsValue == 'Vendors')
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      10.0, 10.0, 10.0, 10.0),
                                  child: Container(
                              ...
                              if (_model.choiceChipsValue == 'Staff')
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      10.0, 10.0, 10.0, 10.0),
                                  child: Container(
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Builder(
                                          builder: (context) {
                                            final project =
                                                listViewProjectRecord.customers
                                                    .toList();
                                            return Column(
                                              mainAxisSize: MainAxisSize.max,
                                              children:
                                                  List.generate(project.length,
                                                      (projectIndex) {
                                                final projectItem =
