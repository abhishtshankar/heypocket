              ...
              children: [
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  5.0, 5.0, 5.0, 5.0),
                                          child: Text(
                                            'Easily Create Projects, Track Every Detail, and Stay Connected to Your Projects, All from Your Pocket',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await ProjectRecord.createDoc(currentUserReference!)
                          .set(createProjectRecordData(
                        nameOfProject: _model.textController1.text,
                        description: _model.textController2.text,
                        userR: currentUserReference,
                      ));
                    },
                    text: 'Create Project',
                    icon: Icon(
