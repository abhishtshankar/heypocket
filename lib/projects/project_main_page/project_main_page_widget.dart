...
import 'project_main_page_model.dart';
export 'project_main_page_model.dart';

class ProjectMainPageWidget extends StatefulWidget {
  const ProjectMainPageWidget({Key? key}) : super(key: key);
...
class _ProjectMainPageWidgetState extends State<ProjectMainPageWidget> {
  late ProjectMainPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectMainPageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProjectRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProjectRecord> projectMainPageProjectRecordList = snapshot.data!;
