...
class _EditVendorWidgetState extends State<EditVendorWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CustomersVendorsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersVendorsRecord> editVendorCustomersVendorsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editVendorCustomersVendorsRecord =
            editVendorCustomersVendorsRecordList.isNotEmpty
                ? editVendorCustomersVendorsRecordList.first
                : null;
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController1 ??=
                                      ...
                                      text: editVendorCustomersVendorsRecord
                                          ?.vendorName,
                                    ),
                                ...
                                TextFormField(
                                  controller: _model.textController2 ??=
                                      TextEditingController(
                                    text:
                                        editVendorCustomersVendorsRecord?.phone,
                                  ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          ...
                                                          TextEditingController(
                                                        text:
                                                            editVendorCustomersVendorsRecord
                                                                ?.email,
                                                      ),
                                                      focusNode: _model
                                                          .textFieldFocusNode3,
