...
import 'add_vendor_model.dart';
export 'add_vendor_model.dart';
...
class _AddVendorWidgetState extends State<AddVendorWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddVendorModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await CustomersVendorsRecord.createDoc(
                      ...
                      vendorName: _model.textController1.text,
                      ...
                      address: createAddressStruct(
                        ...
                        pinCode: int.tryParse(_model.textController6.text),
