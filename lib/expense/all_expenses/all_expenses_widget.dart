                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<ExpenseVsIncomeRecord>>(
                            stream: queryExpenseVsIncomeRecord(
                              queryBuilder: (expenseVsIncomeRecord) =>
                                  expenseVsIncomeRecord.where(
                                'UserRef',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ExpenseVsIncomeRecord>
                                  listViewExpenseVsIncomeRecordList =
                                  snapshot.data!;
                              return ListView.builder(
                                ...
                                itemCount:
                                    listViewExpenseVsIncomeRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewExpenseVsIncomeRecord =
                                      listViewExpenseVsIncomeRecordList[
                                          listViewIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
