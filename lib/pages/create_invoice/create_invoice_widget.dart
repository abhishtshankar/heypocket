...
class CreateInvoiceWidget extends StatefulWidget {
  const CreateInvoiceWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> createInvoiceProductsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createInvoiceProductsRecord =
            createInvoiceProductsRecordList.isNotEmpty
                ? createInvoiceProductsRecordList.first
                : null;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                                      ...
                                      Padding(
                                        ...
                                        child: StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<CustomersVendorsRecord>
                                                customerCustomersVendorsRecordList =
                                                snapshot.data!;
                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .customerValueController ??=
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        FFAppState()
                                                                            .removeFromInvoice(containerProductsRecord.reference);
                                                                      });
                                                                    },
                                                                    child: Icon(
                                                                      Icons
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 45.0, 10.0, 10.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await InvoicesRecord.createDoc(
                                      currentUserReference!)
                                  .set(createInvoicesRecordData(
                                invoiceNo: _model.textController.text,
                                createdat: getCurrentTimestamp,
                                customerDetails: _model.customerValue,
                                userPO: currentUserReference,
                                totalValue: 110.0,
                                discountPrice:
                                    createInvoiceProductsRecord?.discountPrice,
                              ));

                              await createInvoiceProductsRecord!.reference
                                  .update(createProductsRecordData(
                                image: '',
                                quantity: 2,
                              ));
                              await actions.genaratePDFInvoice(
                                context,
