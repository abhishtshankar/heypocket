                        ...
                        child: StreamBuilder<List<CustomersVendorsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<CustomersVendorsRecord>
                                listViewCustomersVendorsRecordList =
                                snapshot.data!;
                            return ListView.builder(
                              ...
                              itemCount:
                                  listViewCustomersVendorsRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewCustomersVendorsRecord =
                                    listViewCustomersVendorsRecordList[
                                        listViewIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 2.0),
                                  child: StreamBuilder<CustomersVendorsRecord>(
                                    stream: CustomersVendorsRecord.getDocument(
                                        listViewCustomersVendorsRecord
                                            .reference),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                      ...
                                      final listTileCustomersVendorsRecord =
                                          snapshot.data!;
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                                          ...
                                          endActionPane: ActionPane(
                                            ...
                                            children: [
                                              ...
                                              SlidableAction(
                                                ...
                                                onPressed: (_) async {
                                                  await listViewCustomersVendorsRecord
                                                      .reference
                                                      .delete();
                                                },
                                              ),
