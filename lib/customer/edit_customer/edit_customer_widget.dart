  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CustomersVendorsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersVendorsRecord> editCustomerCustomersVendorsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editCustomerCustomersVendorsRecord =
            editCustomerCustomersVendorsRecordList.isNotEmpty
                ? editCustomerCustomersVendorsRecordList.first
                : null;
                ...
                children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController1 ??=
                                      ...
                                      text: editCustomerCustomersVendorsRecord
                                          ?.customerName,
                                    ),
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          editCustomerCustomersVendorsRecord
                                              ?.customerName,
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: editCustomerCustomersVendorsRecord
                                        ?.phone,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    enabledBorder: OutlineInputBorder(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.editProfile!
                            .update(createCustomersVendorsRecordData(
