...
import 'payment_in_model.dart';
export 'payment_in_model.dart';
...
class _PaymentInWidgetState extends State<PaymentInWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentInModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProjectRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProjectRecord> paymentInProjectRecordList = snapshot.data!;
